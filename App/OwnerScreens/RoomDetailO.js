...
const ServiceInfo = () => (
  <View style={styles.roominfo}>
      <View style={styles.lineTop}>
        <Text style={styles.textRight}>Giữ xe</Text>
        <Text style={styles.textLeft}>70.000đ/tháng</Text>
      </View>
      <View style={styles.lineBot}>
        <Text style={styles.textRight}>Bảo vệ</Text>
        <Text style={styles.textLeft}>200.000đ/tháng</Text>
      </View>
  </View>
)
